...
- [x] **Step 1: Write failing path and validation-shape tests**
...
- [x] **Step 4: Run focused and complete unit suites**

Run: `node --test workspace-domain.test.mjs`

Expected: all workspace-domain tests PASS.

- [x] **Step 5: Add the module to `check` and `test`, then commit**
...
- [x] **Step 3: Add schema, migration, repository validation, and endpoints**
...
- [x] **Step 1: Add failing cross-project binding tests**
...
- [x] **Step 3: Thread workspace IDs through persistence and execution**
...
- [x] **Step 4: Verify immutable binding GREEN**

Run: `node test.mjs`

Expected: all cross-project binding and existing integration cases PASS.

- [x] **Step 5: Commit execution slice**
...
- [x] **Step 1: Add failing group-turn safety tests**
...
- [x] **Step 3: Implement protected group execution**
...
- [x] **Step 4: Verify group protection GREEN**

Run: `node test.mjs`

Expected: group safety and all existing integration tests PASS.

- [x] **Step 5: Commit group safety slice**
...
- [x] **Step 3: Implement selector UI and project identity**
...
- [x] **Step 5: Commit frontend slice**
...
- [x] **Step 1: Document workspace semantics and configuration**
...
- [x] **Step 3: Start the development server on a free port**

Run AOD from the feature worktree and record the chosen URL.

- [x] **Step 4: Verify in the user's Chrome via CDP 9223**
...
- [x] **Step 5: Save evidence and commit**
